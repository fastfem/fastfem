...
TEMPERATURES = np.zeros((TIME_STEPS, NODES_IN_VERTICAL_DIRECTION, NODES_IN_HORIZONTAL_DRECTION))
...
TEMPERATURES = np.random.uniform(low=MIN_TEMP, high=MAX_TEMP, size=(TIME_STEPS, NODES_IN_VERTICAL_DIRECTION, NODES_IN_HORIZONTAL_DRECTION))
